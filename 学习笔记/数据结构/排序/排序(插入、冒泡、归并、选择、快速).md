...
int main()
{
    ...
    TEST(arr, ARRLEN, quick_sort, brr, ARRLEN) //快速排序 单边循环
    TEST(arr, ARRLEN, quick_sort1, brr, 0, ARRLEN - 1) //快速排序 双边循环
...
![image-20220214051434593](../../../picture/排序(插入、冒泡、归并、选择、快速)/image-20220214051434593.png)
